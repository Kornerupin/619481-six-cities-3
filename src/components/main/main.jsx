            ...
            <div className="cities__places-container container">
              <section className="cities__places places">
                ...
                <b className="places__found">
                  {this.props.currentOffers.length > 0 ? this.props.currentOffers.length : `No `}
                  {` places to stay `}
                  {this.props.currentOffers.length === 0 ? ` available ` : null} in {towns[this.props.currentTown].name}
                </b>
